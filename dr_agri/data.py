...
class CropData:
    ...
    static_idx: np.ndarray   # FarmID, Plant_ID and Date, as in the released code
...
def load_crop(crop: str, task: str = "classification", data_root: Path | None = None) -> CropData:
    ...
    # Drop CSV index artefacts only.  FarmID, Plant_ID and day-of-year are kept,
    # exactly as in the paper-linked implementation and data description.
